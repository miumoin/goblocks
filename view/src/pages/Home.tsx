        ...
        <>
            ...
            <div className="cover-container d-flex h-100 p-3 mx-auto flex-column" style={{minHeight: '70vh', maxWidth: '44em', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', textAlign: 'center'}}>
                <main role="main" className="inner cover">
                    <h1 className="cover-heading">Chat. Sell. Get Paid.</h1>
                    <p className="lead">A smart tool that instantly creates invoices during conversations - so your chatbot can sell and accept payments on the fly.</p>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            ...
                            <div className="letter-content" style={{ fontSize: '1.2rem', animation: 'fadeIn 1s ease-in' }}>
                                ...
                                <p>In real business, sales don’t always start on a website or end in a checkout cart.</p>
    
                                <p>They start with a conversation — someone asking a question, exploring options, or simply saying, “Can you send me the price?”</p>

                                <p>But most sales tools aren’t built for that. They expect forms, product pages, and manual steps.</p>

                                <p>They don’t understand that your customer might already be talking to your chatbot — or even your AI assistant — ready to buy right there in the chat.</p>
                                
                                <p className="highlight" style={{ fontSize: '1.3rem', fontWeight: 500, textDecoration: 'underline' }}>That’s why we built a smarter way to sell.</p>
                                
                                <p>With Chat. Sell. Get Paid., your chatbot can instantly create an invoice while chatting — dynamically, on the fly — and process payments right there.</p>

                                <p className="highlight" style={{ fontSize: '1.3rem', fontWeight: 500, textDecoration: 'underline' }}>No switching tabs. No lost leads. No waiting for follow-up emails.</p>

                                <p>Whether you’re using CustomGPT, Typewriting AI, or any other shareable chatbot platform, this tool fits right in — letting your conversations become sales, not just chats.</p>

                                <p className="highlight" style={{ fontSize: '1.3rem', fontWeight: 500, textDecoration: 'underline' }}>It’s not just automation.</p>

                                <p className="highlight" style={{ fontSize: '1.3rem', fontWeight: 500, textDecoration: 'underline' }}>It’s real-time commerce — powered by AI.</p>
                            ...
                            <div className="col-md-6">
                                <div className="feature-card p-4 rounded shadow-sm h-100">
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <h4 className="mb-0">Sales Happen in Conversation</h4>
                                    </div>
                                    <p className="mb-0">Customers already ask questions, negotiate, and decide inside chat windows. Instead of pushing them to a separate checkout page, this tool lets you close the deal right inside the chat — no friction, no drop-offs.</p>
                                </div>
                            </div>
                            ...
                            <div className="col-md-6">
                                <div className="feature-card p-4 rounded shadow-sm h-100">
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <h4 className="mb-0">On-the-Fly Invoicing</h4>
                                    </div>
                                    <p className="mb-0">Unlike static eCommerce listings, your chatbot can generate a custom invoice instantly, based on what the customer needs. Perfect for personalized offers, service-based pricing, or quick deals without setup.</p>
                                </div>
                            </div>
                            ...
                            <div className="col-md-6">
                                <div className="feature-card p-4 rounded shadow-sm h-100">
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <h4 className="mb-0">Built for Chatbots</h4>
                                    </div>
                                    <p className="mb-0">Where traditional checkout systems depend on complex storefronts, this tool plugs directly into CustomGPT, Typewriting AI, or any AI chatbot — turning conversations into transactions automatically.</p>
                                </div>
                            </div>
                            ...
                            <div className="col-md-6">
                                <div className="feature-card p-4 rounded shadow-sm h-100">
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <h4 className="mb-0">Instant Payment</h4>
                                    </div>
                                    <p className="mb-0">No waiting for manual payment links or follow-up messages. Customers can pay directly in the chat, get an instant confirmation, and you get paid faster — all within a seamless, human-like experience.</p>
                                </div>
                            </div>
                        </div>
